...
INSERT INTO `student` (`id`, `first_name`, `last_name`,  `created`, `updated`)
 VALUES (1,'John','Smith',now(),now()),(2,'Milly','Molly',now(),now()),(3,'Tsien','Tsien',now(),now());

-- data for table `course`
INSERT INTO `course` (`course_id`, `course_code`, `course_title`, `year`, `semester`, `credit_units`, `online`, `created`, `updated`)
   VALUES (1,'CST8277','Enterprise Application Programming',2022,'AUTUMN',3,0,now(),now()),(2,'CST8284','Object-Oriented Programming in Java',2023,'WINTER',3,1,now(),now()),(3,'CST1170','Android Programming',2025,'WINTER',3,1,now(),now()), (4,'CST3317','C Programming',2025,'FALL',2,0,now(),now());
...
INSERT INTO `club_membership` (`membership_id`, `club_id`, `start_date`, `end_date`, `active`, `created`, `updated`)
  VALUES (1,2,now(),now(),0,now(),now()),(2,2,now(),now(),0,now(),now()), (3,1,now(),now(),0,now(),now());
...
INSERT INTO `course_registration` (`student_id`, `course_id`, `numeric_grade`, `letter_grade`, `professor_id`, `created`, `updated`)
  VALUES (1,1,100,'A+',1,now(),now()),(1,2,85,NULL,NULL,now(),now()), (2,1,90,'A',1,now(),now()), (3,3,80,'A-',1,now(),now());
...
INSERT INTO `security_user` (`user_id`, `password_hash`, `username`, `student_id`)
  ...
  (3, 'PBKDF2WithHmacSHA256:2048:i6ZzrfDRl6gAf1rX2sLeIdZMqsDPpEtYKSbDD19QR5s=:NUIFNu2lDJZr6s51rL44KqQw/PCf8eG1/t0II37jcj0=', 'hank', null);
