...
public interface MyConstants {
    ...
    public static final String STUDENT_COURSE_RESOURCE_PATH = "/{studentId}/course/{courseId}";
    ...
    public static final String DEFAULT_INVALID_USER = "hank";
    public static final String DEFAULT_INVALID_USER_PASSWORD = "han";
