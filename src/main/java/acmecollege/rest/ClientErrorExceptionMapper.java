 ...
 * 
 * @see <a href=
 *      "https://javaee.github.io/javaee-spec/javadocs/javax./ws/rs/ClientErrorException.html">JavaEE
 *      8 ClientErrorException</a>
 * @see <a href=
 *      "https://javaee.github.io/javaee-spec/javadocs/javax./ws/rs/ext/ExceptionMapper.html">JavaEE
 *      8 ExceptionMapper</a>
 */
@Provider
public class ClientErrorExceptionMapper implements ExceptionMapper<ClientErrorException> {
	...
	public Response toResponse(ClientErrorException exception) {
		StatusType statusType = exception.getResponse().getStatusInfo();
